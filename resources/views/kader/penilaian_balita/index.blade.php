<x-kader-layout>
    ...
    <div class="p-6">
        ...
        <div class="mb-4 flex flex-wrap gap-2">
            ...
            <a href="{{ route('penilaian_balita.create_massal') }}"
                class="inline-flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm font-medium
                ...
                <tbody class="divide-y">
                    @forelse($penilaians as $balita_id => $items)
                        @php
                            ...
                            $tanggalPenilaian = $items->first()->tanggal_penilaian ?? $items->first()->created_at;
                        @endphp
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3 text-gray-600 whitespace-nowrap">
                                {{ $tanggalPenilaian ? \Carbon\Carbon::parse($tanggalPenilaian)->translatedFormat('d F Y') : '-' }}
                            </td>
                                            ...
                                            <div @click.away="close()"
                                                ...
                                                <div class="text-center mt-4">
                                                    ...
                                                    <p class="text-gray-500 mt-2">
                                                        ...
                                                        <span
                                                            class="font-medium text-gray-800">{{ $balita->nama ?? '-' }}</span>?
                                                    </p>
                                                </div>
                                                ...
                                                <div class="flex gap-3 mt-6">
                                                    ...
                                                    {{-- DELETE --}}
                                                    <form
                                                        action="{{ route('penilaian_balita.destroy', $realBalitaId) }}"
