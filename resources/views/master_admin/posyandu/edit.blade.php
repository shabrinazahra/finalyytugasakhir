    ...
    <div class="p-6 max-w-5xl">
        ...
        <div class="mb-4">
            ...
            <p class="text-sm text-gray-500 mt-1">
                Ubah informasi posyandu sesuai kebutuhan
            </p>
        </div>

        <form method="POST" action="{{ route('posyandu.update', $posyandu->id) }}" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <textarea name="alamat" required
                class="w-full border rounded-lg px-3 py-2
                     focus:ring-2 focus:ring-[#1B3C53] focus:border-[#1B3C53] outline-none transition">{{ $posyandu->alamat }}</textarea>
